...
async function resolveGeometry(query) {
  // No external geocoding available. Return default geometry.
...
module.exports.createListing = async (req, res, next) => {
  ...
  newListing.geometry = await resolveGeometry(req.body.listing.location);
...
module.exports.renderEditForm = async (req, res) => {
  ...
  let imageUrl = getDisplayImageUrl(listing.image.url);
  res.render("listings/edit.ejs", { listing, imageUrl });
};

module.exports.updateListing = async (req, res, next) => {
  let { id } = req.params;
  req.body.listing.geometry = await resolveGeometry(
